...
bbs.replace_text(071,color.normal + "Reading %4u %s %4u (`?==Menu) (%u of %u):\1n");
...
bbs.replace_text(345,"@GOTOXY:3,20@" + color.normal + "Enter your birthday @DATEFMT@YY\1n" + color.dark + ":\1n " + color.normal);
bbs.replace_text(342,color.normal + "Enter your Gender Identity: M/F/Non-binary/Other (@GENDERS@)" + color.dark + ": \1n" + color.normal);
...
bbs.replace_text(764,"@MENU:newuser@"); // replace with ansi
...
bbs.replace_text(563,color.dark + "[\1n" + dittoText(color.normal + "pause\1n" + color.dark + "/\1n" + color.bright + "press any key") + "\1n" + color.dark + "]\1n");
...
bbs.replace_text(621,"\r\n"
					...
					+ color.dark + " "
					+ bracket("A")
					+ color.normal + " All Message Groups\r\n\r\n"
					+ color.dark + " "
					+ quesBox
					+ color.bright + " S"
					+ color.normal + ", " 
					...
					+ color.normal + ". "
					+ bracket("ENTER")
					+ color.normal + " to Cancel"
					+ color.dark + ":" );	
					
bbs.replace_text(622,"\r\n"
					+ color.normal + " "
					+ bracket("L")
					+ color.normal + " Library  : "
					+ color.bright + " @LIBL@\r\n"
					+ color.dark + " "
					+ bracket("D")
					+ color.normal + " Directory: "
					+ color.bright + " @DIRL@\r\n"
					+ color.dark + " "
					+ bracket("A")
					+ color.normal + " All File Locations\r\n\r\n"
					+ color.dark + " "
					+ quesBox
					+ color.bright + " L"
					+ color.normal + ", " 
...
//bbs.replace_text(660,"@EXEC:/sbbs/mods/ddflistf.js@");
bbs.replace_text(661,"@EXEC:/sbbs/mods/ddflisth.js@");
bbs.replace_text(811,quesBox + dittoText(color.normal + " HIT your \1n" + color.dark + "BACKSPACE\1n" + color.normal +" or \1n" + color.dark + "DELETE-LEFT\1n" + color.normal + " key:") + "\1n "); 
